...
if (typeof CustomCardVariantOptions === 'undefined') {
  window.CustomCardVariantOptions = class CustomCardVariantOptions {
    ...
    async addToCartDirectly(variant, card) {
      ...
      const isAvailable =
        variant.inventory_management === 'shopify' ? variant.inventory_quantity > 0 : variant.available;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  variantOptionContainers.forEach((container) => {
    new window.CustomCardVariantOptions(container);
  });
});
